...
class User(UserMixin, db.Model):
    ...
    listened_songs = db.relationship(
        'ListenedSong', backref='listener', lazy=True)
...
class Playlist(db.Model):
    ...
    songs = db.relationship('PlaylistSong', backref=backref(
        'Playlist', lazy='joined'), lazy=True, cascade="all, delete-orphan")
    __table_args__ = (UniqueConstraint(
        'user_id', 'name', name='_user_playlist_name_uc'),)
